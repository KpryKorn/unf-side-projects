export function SuccessToast({ text }: { text: string }) {
  return (
    <article
      className="fixed z-10 bottom-10 right-1/2 translate-x-1/2 animate-slideInFromBottom max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700"
      role="alert"
    >
  ...
  return (
    ...
    >
      <div className="flex p-4">
        <div className="flex-shrink-0">
          <svg
            className="flex-shrink-0 h-4 w-4 text-yellow-500 mt-0.5"
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
